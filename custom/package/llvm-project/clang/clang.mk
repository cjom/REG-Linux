...
CLANG_SITE = https://github.com/cjom/REG-llvm-binaries/releases/download/$(CLANG_VERSION)
...
define DELETE_CLANG_PATCH_IF_NOT_BUILD_FROM_SOURCE
	rm -f $(PROJECT_DIR)/buildroot/package/llvm-project/clang/*.patch $(PROJECT_DIR)/buildroot/package/llvm-project/clang/*.hash
endef
