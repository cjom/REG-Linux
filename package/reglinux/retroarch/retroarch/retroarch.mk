...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_CHA),y)
	TARGET_CONFIGURE_OPTS += HAVE_LAKKA=1 HAVE_LAKKA_PROJECT="CHA.arm" HAVE_LAKKA_SERVER="https://updates.reglinux.org" HAVE_WIFI=1 HAVE_NETWORKING=1 HAVE_BLUETOOTH=0 HAVE_FREETYPE=1 HAVE_CHOKOGROUP=1 BR_COMPILER_PARANOID_UNSAFE_PATH=
endif
