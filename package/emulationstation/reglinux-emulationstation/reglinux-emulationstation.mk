...
# branch: cjomtest
REGLINUX_EMULATIONSTATION_VERSION = 7a57510e160c7dcfe2a6cc17ef79e7634aadadcb
...
REGLINUX_EMULATIONSTATION_DEPENDENCIES = sdl3 sdl3_mixer libyuv libfreeimage zeromq cppzmq
REGLINUX_EMULATIONSTATION_DEPENDENCIES += freetype alsa-lib libcurl rapidjson libarchive
...
REGLINUX_EMULATIONSTATION_CONF_OPTS += -DFFMPEG_DIR="$(STAGING_DIR)/usr/lib/es-ffmpeg"
...
REGLINUX_EMULATIONSTATION_DEPENDENCIES += es-ffmpeg
else
