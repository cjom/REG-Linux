...
ifeq ($(BR2_PACKAGE_SYSTEM_TARGET_BCM2835)$(BR2_PACKAGE_SYSTEM_TARGET_RK3128)$(BR2_PACKAGE_SYSTEM_TARGET_JZ4770),y)
...
# Scraping keys
REGLINUX_EMULATIONSTATION_CONF_OPTS += "-DSCREENSCRAPER_DEV_LOGIN=$(shell echo $SCREENSCRAPER_DEV_LOGIN)"
REGLINUX_EMULATIONSTATION_CONF_OPTS += "-DGAMESDB_APIKEY=$(shell echo $GAMESDB_APIKEY)"
REGLINUX_EMULATIONSTATION_CONF_OPTS += "-DCHEEVOS_DEV_LOGIN=$(shell echo $CHEEVOS_DEV_LOGIN)"
REGLINUX_EMULATIONSTATION_CONF_OPTS += "-DHFS_DEV_LOGIN=$(shell echo $HFS_DEV_LOGIN)"
